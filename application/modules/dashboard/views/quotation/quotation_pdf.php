        ...
        <div class="panel panel-bd">
            ...
            <link href="<?php echo MOD_URL.'dashboard/assets/css/print.css'; ?>" rel="stylesheet" type="text/css"/>
                <div class="panel-body">
                    <div class="row height_200">
                        <div class="col-sm-8 inv_logo_div">
                            <img src="<?php if (isset($invoice_logo)) {echo $invoice_logo; }?>" class="inv_logo2" alt="">
                            <br>
                        ...
                        <div class="col-sm-4 text-left quotation_div">
                            ...
                            <div class="mb_15"><?php echo display('quotation_date') ?>: {final_date}</div>
                        ...
                        <div class="col-sm-12 mt_10">
                            ...
                            <div class="details_div2">
		                        ...
		                        <table class="table table-striped table-bordered cizgili" border="0" cellspacing="0" cellpadding="0">
	                            	...
	                            	<tr>
	                            		<th class="b_1"><?php echo display('total_discount') ?> : </th>
									...
									if ($tax_info) { ?>
			                    	<tr>
			                    		<th class="b_1" class="total_cgst"><?php echo html_escape($tax_info->tax_name) ?> :</th>
									...
									if ($tax_info) { ?>
			                    	<tr>
			                    		<th class="b_1" class="total_sgst"><?php echo html_escape($tax_info->tax_name) ?> :</th>
									...
									?>
			                    	<tr>
			                    		<th class="b_1" class="total_igst"><?php echo html_escape($tax_info->tax_name) ?> :</th>
