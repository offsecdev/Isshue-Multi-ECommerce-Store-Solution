	                    ...
	                    <div class="panel-body">
	                        <div class="row">
	                            ...
	                            <div class="col-sm-10 cominfo_div">
	                                <img src="<?php if (isset($Soft_settings[0]['invoice_logo'])) {echo $Soft_settings[0]['invoice_logo']; }?>" class="img img-responsive inv_logo" alt="">
	                                <br>
		                            ...
		                            <div class="width_30p ft_left">
				                        ...
				                        <table class="table">
			                            	...
			                            	<tr>
			                            		...
			                            		<td class="bt_bb_0"><?php echo (($position==0)?"$currency {quotation_discount}":"{quotation_discount} $currency") ?> </td>
			                            	</tr>
				                            <?php }
