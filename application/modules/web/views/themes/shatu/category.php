                                            ...
                                            <li>
                                                <?php if($is_aff){ 
                                                    if($product->is_affiliate == 1 ){ ?>
                                                        <a id="affiliate_btn" href="<?php echo html_escape($product->affiliate_url) ?>" title="<?php echo display('buy_now') ?>" target="0">
                                                            <i class="fa fa-shopping-bag"></i>
                                                        </a>
                                                <?php }else{ ?> 
                                                    <a href="javascript:void(0)" title="<?php echo display('add_to_cart') ?>" onclick="add_to_cart_item('<?php echo $product->product_id; ?>','<?php echo  remove_space($product->product_name);?>', '<?php echo html_escape($product->default_variant); ?>', <?php echo $product->variant_price; ?>)">
                                                       <i class="fa fa-shopping-bag"></i>
                                                    </a>
                                                <?php } }else{ ?>
                                                    <a href="javascript:void(0)" title="<?php echo display('add_to_cart') ?>" onclick="add_to_cart_item('<?php echo $product->product_id; ?>','<?php echo  remove_space($product->product_name);?>', '<?php echo html_escape($product->default_variant); ?>', <?php echo $product->variant_price; ?>)">
            ...
            <div class="item_inner pos-rel">
                ...
                <div class="item_info text-center">
                    ...
                    <div class="hover_content">
                        <ul class="nav">
                            <li>
                                <a href="#" class="wishlist" name="<?php echo html_escape($product->product_id); ?>"title="<?php echo display('add_to_wishlist') ?>">
