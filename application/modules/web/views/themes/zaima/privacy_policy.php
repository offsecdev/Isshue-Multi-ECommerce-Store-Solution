    ...
    <div class="container">
        <nav aria-label="breadcrumb" class="my-4">
                <ol class="breadcrumb d-inline-flex mb-0">
                    ...
                    <li class="breadcrumb-item align-items-center"><a href="" class="d-flex align-items-center"><?php echo display('privacy_policy') ?></a></li>
                </ol>
            </nav>
    </div>
</div>
        ...
        <div class="row m-0 d-flex">
            <div class="col-md-12  align-self-center">
                <div class="welcome-inner">
                    <h1 class="text-center mb-4"><?php echo display('privacy_policy') ?></h1>
                    <?php if(!empty($image)){ ?>
                        <div class="col-md-6">
                            <img src="<?php echo base_url().$image; ?>" class="img-thumbnail img-fluid float-left mr-5 mb-3" alt="Img">
                        </div>
                    <?php } ?>
