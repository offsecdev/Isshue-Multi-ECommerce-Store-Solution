    ...
    <h4 class="mb-25 text-center"><?php echo display('create_your_account')?></h4>
        ...
        <div class="form-group">
            <label class="control-label" for="first_name"><?php echo display
                ('first_name')?><span class="text-danger" title="required">*</span></label>
            <input type="text" id="first_name" class="form-control" name="first_name" placeholder="<?php echo display('first_name')?>" required>
        </div>
        <div class="form-group">
            <label class="control-label" for="last_name"><?php echo display('last_name')?></label>
            <input type="text" id="last_name" placeholder="<?php echo display('last_name')?>" class="form-control" name="last_name">
        </div>
        <div class="form-group">
